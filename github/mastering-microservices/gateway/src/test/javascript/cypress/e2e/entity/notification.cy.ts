...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2023-01-27T16:41:08.457Z',
    sentDate: '2023-01-27T17:08:11.531Z',
    format: 'EMAIL',
    userId: 20600,
    productId: 75536,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2023-01-27T00:10').blur().should('have.value', '2023-01-27T00:10');

      cy.get(`[data-cy="details"]`).type('firewall multimedia').should('have.value', 'firewall multimedia');

      cy.get(`[data-cy="sentDate"]`).type('2023-01-27T09:49').blur().should('have.value', '2023-01-27T09:49');
