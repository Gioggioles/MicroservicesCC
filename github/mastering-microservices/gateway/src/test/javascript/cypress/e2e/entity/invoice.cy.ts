...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2023-01-27T16:03:39.470Z',
    status: 'PAID',
    paymentMethod: 'PAYPAL',
    paymentDate: '2023-01-27T15:00:10.622Z',
    paymentAmount: 4928,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2023-01-27T04:33').blur().should('have.value', '2023-01-27T04:33');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2023-01-27T11:01').blur().should('have.value', '2023-01-27T11:01');
