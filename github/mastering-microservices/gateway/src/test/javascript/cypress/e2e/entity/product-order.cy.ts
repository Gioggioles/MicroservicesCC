...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2023-01-27T20:07:10.294Z', status: 'CANCELLED', code: 'Buckinghamshire' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2023-01-27T14:18').blur().should('have.value', '2023-01-27T14:18');
