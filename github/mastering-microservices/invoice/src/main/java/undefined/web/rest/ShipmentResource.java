...
import mosig.cloud.store.invoice.repository.ShipmentRepository;
import mosig.cloud.store.invoice.service.ShipmentService;
import mosig.cloud.store.invoice.service.dto.ShipmentDTO;
import mosig.cloud.store.invoice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link mosig.cloud.store.invoice.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
