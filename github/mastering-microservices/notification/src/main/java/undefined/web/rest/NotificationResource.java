package mosig.cloud.store.notification.web.rest;
...
import mosig.cloud.store.notification.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link mosig.cloud.store.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
