...
```
$ docker image tag gateway gioggioles/gateway
$ docker push gioggioles/gateway
$ docker image tag invoice gioggioles/invoice
$ docker push gioggioles/invoice
$ docker image tag notification gioggioles/notification
$ docker push gioggioles/notification
$ docker image tag productorder gioggioles/productorder
$ docker push gioggioles/productorder
```
