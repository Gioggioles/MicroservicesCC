package mosig.cloud.store.invoice.web.rest;

import static mosig.cloud.store.invoice.web.rest.TestUtil.sameNumber;
...
import mosig.cloud.store.invoice.domain.enumeration.InvoiceStatus;
import mosig.cloud.store.invoice.domain.enumeration.PaymentMethod;
import mosig.cloud.store.invoice.repository.InvoiceRepository;
import mosig.cloud.store.invoice.service.dto.InvoiceDTO;
import mosig.cloud.store.invoice.service.mapper.InvoiceMapper;
